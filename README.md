...
- [github-flow](http://scottchacon.com/2011/08/31/github-flow.html)をベースに開発する

### Git Flow の主なルール

### master ブランチ

- 製品として出荷可能な状態であり、アプリケーションが安定して動く状態にしておく

### develop ブランチ（開発用ブランチ）

- 次のリリースのための最新の開発作業の変更が反映されている状態。このブランチが常に最新。

### feature ブランチ（サポートブランチ）
...
- 以下の中から用途に合った接頭辞をつける
  ...
  - **test**: 欠落している**テストの**追加または既存のテストの修正
